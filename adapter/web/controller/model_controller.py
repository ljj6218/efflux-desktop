...
@router.get("/model/fetch")
async def model_fetch(firm: str, model_case: ModelCase = Depends(get_model_case)):
    return BaseResponse.from_success(data=await model_case.model_list_fetch(firm))
